          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Next
              </button>
            </div>
